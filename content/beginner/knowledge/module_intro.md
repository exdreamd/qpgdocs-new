...
![](./assets/ec20-naked-top.png "某 4G 模块的内部图像")
...
![](./assets/ec20-inner-components.png "EC20 Mini PCIe 模块的元件组成")
...
![](./assets/qcx216-diagram.png "高通 QCX216 4G Modem 芯片功能框图")
...
![](./assets/at-command-architecture.png "AT 指令的运行方式")
